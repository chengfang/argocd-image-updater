...
`,
	...
	controllerCmd.Flags().StringVar(&webhookCfg.TLSCertFile, "tls-cert-file", env.GetStringVal("TLS_CERT_FILE", webhook.DefaultTLSCertPath), "Path to TLS certificate file. If not found, a self-signed certificate is generated.")
	controllerCmd.Flags().StringVar(&webhookCfg.TLSKeyFile, "tls-key-file", env.GetStringVal("TLS_KEY_FILE", webhook.DefaultTLSKeyPath), "Path to TLS private key file. If not found, a self-signed certificate is generated.")
